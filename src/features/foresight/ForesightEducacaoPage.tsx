 ...
 * observado, o que é comum aos quatro cenários e, então, cada cenário. A rota
 * só é alcançável quando o manifesto declara o município publicado; esta página
 * nunca é montada em vazio.
 */
