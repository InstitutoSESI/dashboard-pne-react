/*
 * Camada de conclusões — contrato `vocacoes-regiao-2.7.0` (V5 R1; nasceu no 2.5.0, decisão V2-D8).
 *
...
test('as dez regiões publicam síntese 2.7.0 sha-verificada e válida', () => {
  assert.equal(manifest.documentSchemaVersion, 'vocacoes-regiao-2.7.0')
  assert.equal(manifest.regions.length, 10)
  for (const [slug, document] of Object.entries(documents)) {
    assert.equal(document.schemaVersion, 'vocacoes-regiao-2.7.0', slug)
