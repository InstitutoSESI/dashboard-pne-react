...
import {
  EDUCATION_SECTION_CONTEXT_TITLES,
    ...
    <main className="education-landing-page">
      <section className="education-landing-summary" aria-labelledby="education-landing-title">
        <div className="education-landing-summary__intro">
          <span className="eyebrow">Indicadores educacionais / Visão geral</span>
          <h1 id="education-landing-title">{EDUCATION_SECTION_CONTEXT_TITLES[EDUCATION_SECTION_KEYS.overview]}</h1>
      ...
      <section className="education-landing-paths" aria-labelledby="education-paths-title">
        <header>
          <h2 id="education-paths-title">Dimensões da educação municipal</h2>
      ...
      <details className="page-card education-landing-concepts">
        <summary>
          <strong>Conceitos importantes para interpretar os dados</strong>
      ...
      <aside className="education-landing-sources" aria-labelledby="education-landing-sources-title">
        <h2 id="education-landing-sources-title">Fontes das informações apresentadas</h2>
