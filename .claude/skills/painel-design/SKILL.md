...
| Gap | 36 | **22** |
| Raio de borda | 6 | **4** |
| Fundo de superfície | 28 | **25** |
| Borda (cor + espessura) | 20 | **19** |
| Assinaturas de cartão | 32 | **28** |
| Tamanhos de ícone | 12 | **5** |
| Achados do detector | 844 | **225** |
...
Os **199 achados de cor restantes** são majoritariamente `rgba` do verde da marca em opacidades variadas — o detector conta cada alfa como cor não documentada. Avalie caso a caso antes de "corrigir".
