SELECT
    ...
    (
        ...
        + t18.populacao_18_24_fundamental_concluido
        + t18.populacao_25_29_fundamental_concluido
    ) AS populacao_15_29_ensino_fundamental_concluido,
    (
        t15.populacao_15_17_total
        + t18.populacao_18_24_total
        + t18.populacao_25_29_total
    ) AS populacao_15_29_total,
    100.0 * (
        t15.populacao_15_17_ensino_medio_ou_basica_completa
        + t18.populacao_18_24_fundamental_concluido
        + t18.populacao_25_29_fundamental_concluido
        ...
        + t18.populacao_25_29_total,
        0
    ) AS percentual_15_29_ensino_fundamental_concluido
