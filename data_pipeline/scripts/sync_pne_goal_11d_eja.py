#!/usr/bin/env python3
"""Valida ou materializa o snapshot agregado da relação 11.d."""
...
from src.pne_goal_11d import SNAPSHOT_DIR, build_snapshot, sha256_bytes  # noqa: E402
...
def _source_dir(value: str | None) -> Path:
    configured = value or os.environ.get("PNE_GOAL_11D_SOURCE_DIR")
    if not configured:
        raise ValueError("Informe --source-dir ou PNE_GOAL_11D_SOURCE_DIR.")
...
def main() -> int:
    ...
    parser.add_argument("--denominator-dir", type=Path)
    ...
    files = build_snapshot(
        ...
        denominator_dir=args.denominator_dir,
