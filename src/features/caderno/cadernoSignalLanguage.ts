import type { CadernoMonitoringSignal, CadernoSignal } from './cadernoTypes'

/*
 * Linguagem pública dos sinais associados às hipóteses.
 *
...
export interface CadernoSignalReading {
...
export function resolveSignalReading(
  signal: CadernoSignal | CadernoMonitoringSignal,
): CadernoSignalReading | null {
