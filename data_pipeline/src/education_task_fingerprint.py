...
O mesmo contrato sustenta dois modos: ``shadow`` apenas mede a elegibilidade;
``incremental`` permite reutilizar a publicacao somente quando input e todos os
outputs administrados forem comprovadamente identicos. O estado local e uma
prova de integridade e nunca e usado como fonte analitica.
"""
