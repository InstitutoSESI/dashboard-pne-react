...
Antecessores: `PLANO_REORGANIZACAO_PLATAFORMA_V1.md` (Fases 0–6 fechadas; §6 reservou este
...
**Objetivo:** concluir a Fase 7 de `PLANO_REORGANIZACAO_PLATAFORMA_V1.md` e mergear
...
PLANO_REORGANIZACAO_PLATAFORMA_V1.md (Fase 7). Execute a Rodada 0 conforme o
